...
$(function(){
    ...
    querySpecPageUrl = baseUrl+'/spec/findAllQueryWithOutSheathtongue';
    inti_page();
    //新增点击事件
...
//根据权限初始化页面
function  inti_page() {
    if(hasAuthority('sheathtongue','auth_create')){
        $('#btn_add').removeClass('hide');
    }else{
        $('#btn_add').addClass('hide');
    }
    if(hasAuthority('sheathtongue','auth_delete')){
        ...
        columns:[//列数据
            ...
            },
            {
                ...
                formatter:function(value,row,index){//格式化，自定义内容
                    var _html='';
                    if(hasAuthority('sheathtongue','auth_edit')){
